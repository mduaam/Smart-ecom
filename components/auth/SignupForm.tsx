    ...
    return (
        <div className="w-full max-w-md bg-white dark:bg-zinc-900 rounded-[2rem] border border-zinc-200 dark:border-zinc-800 shadow-2xl shadow-indigo-500/10 p-8 md:p-12">
            ...
            <form action={formAction} className="space-y-6">
                <div className="space-y-2">
                    ...
                    <div className="relative group">
                        <User className="absolute left-4 top-3.5 w-5 h-5 text-zinc-400 group-focus-within:text-indigo-600 transition-colors" />
                        <input
                            type="text"
                            name="fullName"
                            placeholder={t('namePlaceholder')}
                            className="w-full pl-12 pr-4 py-3 bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-xl focus:ring-2 focus:ring-indigo-600 outline-none transition-all dark:text-white"
                        />
                    </div>
                    {clientErrors.fullName && <p className="text-xs text-red-500 ml-1">{clientErrors.fullName}</p>}
                </div>
                ...
                <div className="space-y-2">
                    ...
                    {clientErrors.email && <p className="text-xs text-red-500 ml-1">{clientErrors.email}</p>}
                </div>
                ...
                <div className="space-y-2">
                    ...
                    {clientErrors.password && <p className="text-xs text-red-500 ml-1">{clientErrors.password}</p>}
                </div>
                ...
                <div className="space-y-2">
                    ...
                    {clientErrors.confirmPassword && <p className="text-xs text-red-500 ml-1">{clientErrors.confirmPassword}</p>}
                </div>
            ...
            <button
                ...
                className="w-full py-3 bg-white dark:bg-black border border-zinc-200 dark:border-zinc-800 text-zinc-700 dark:text-zinc-200 font-medium rounded-xl hover:bg-zinc-50 dark:hover:bg-zinc-900 transition-all flex items-center justify-center gap-2"
            >
